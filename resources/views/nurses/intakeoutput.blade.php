...
@section('chart_content')
	...
	<div class="container-fluid">
		...
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#intakeoutputModal">
			...
			<div class="modal-dialog" role="document">
    			<div class="modal-content">
  		    		<div class="modal-header">
        				<h5 class="modal-title" id="intakeoutputModalLabel">Input Intake Output for Patient {{ $pat->last_name }}, {{ $pat->first_name }} {{ $pat->middle_name }}</h5>
